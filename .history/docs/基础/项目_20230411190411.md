...
2. 测试工具集的收敛：部门很大，自动化测试工具很多：单元测试，集成测试，UI 自动化测试，兼容性测试，接口测试，客户端、服务端等自动化测试，外面部门很迷惑，不知道入口在哪，文档分散，所以收敛，需要统一的工具，本地研发了一个 cli，远程在流水线上，开发了蓝盾原子，借助远程蓝盾流水线环境，增强了功能，实现了远程调度
